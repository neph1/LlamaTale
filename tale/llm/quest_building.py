...
class QuestBuilding():
    ...
    def generate_quest(self, base_quest: dict, character_name: str, location: Location, story_context: str, character_card: str = '', story_type: str = '', world_info: str = '', zone_info: str = '') -> Quest:
    ...
    def generate_note_quest(self, story_context: str, story_type: str, world_info: str, zone_info: str) -> Quest:
        prompt = self.pre_prompt
