...
class FollowContext(ActionContext):
    ...
    def __init__(self, story_context: str, story_type: str, character_name: str, character_card: CharacterCard, event_history: str, location: Location, asker_name: str, asker_card: str, asker_reason: str):
