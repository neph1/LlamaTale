...
class DungeonLocationsContext(WorldGenerationContext):
    ...
    def __init__(self, story_context: str, story_type: str, world_info: str, world_mood: int, zone_info: dict, rooms: list) -> None:
        super().__init__(story_context, story_type, world_info, world_mood)
        self.zone = zone_info
        self.rooms = rooms

    def to_prompt_string(self) -> str:
        return f"{super().to_prompt_string}; Zone: {self.zone}; Rooms:{', '.join(self.rooms)};"